    ...
    if (this.location.id) {
      this.locationService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('primeiraAplicacaoJHipsterApp.location.updated', { param: param.id });
      ...
      this.locationService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('primeiraAplicacaoJHipsterApp.location.created', { param: param.id });
