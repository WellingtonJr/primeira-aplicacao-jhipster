    ...
    if (this.country.id) {
      this.countryService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('primeiraAplicacaoJHipsterApp.country.updated', { param: param.id });
      ...
      this.countryService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('primeiraAplicacaoJHipsterApp.country.created', { param: param.id });
