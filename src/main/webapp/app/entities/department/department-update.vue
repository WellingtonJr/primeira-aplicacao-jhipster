  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="primeiraAplicacaoJHipsterApp.department.home.createOrEditLabel"
          data-cy="DepartmentCreateUpdateHeading"
          v-text="$t('primeiraAplicacaoJHipsterApp.department.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="$t('primeiraAplicacaoJHipsterApp.department.departmentName')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('primeiraAplicacaoJHipsterApp.department.location')" for="department-location"
              >Location</label
            >
