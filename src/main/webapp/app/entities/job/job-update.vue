  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="primeiraAplicacaoJHipsterApp.job.home.createOrEditLabel"
          data-cy="JobCreateUpdateHeading"
          v-text="$t('primeiraAplicacaoJHipsterApp.job.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('primeiraAplicacaoJHipsterApp.job.jobTitle')" for="job-jobTitle">Job Title</label>
            <input
              type="text"
              class="form-control"
              name="jobTitle"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('primeiraAplicacaoJHipsterApp.job.minSalary')" for="job-minSalary"
              >Min Salary</label
            >
            <input
              type="number"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('primeiraAplicacaoJHipsterApp.job.maxSalary')" for="job-maxSalary"
              >Max Salary</label
            >
            <input
              type="number"
          ...
          <div class="form-group">
            <label v-text="$t('primeiraAplicacaoJHipsterApp.job.task')" for="job-task">Task</label>
            <select
              class="form-control"
              id="job-tasks"
              data-cy="task"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('primeiraAplicacaoJHipsterApp.job.employee')" for="job-employee">Employee</label>
