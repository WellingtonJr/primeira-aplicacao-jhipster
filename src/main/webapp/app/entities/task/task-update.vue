  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="primeiraAplicacaoJHipsterApp.task.home.createOrEditLabel"
          data-cy="TaskCreateUpdateHeading"
          v-text="$t('primeiraAplicacaoJHipsterApp.task.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('primeiraAplicacaoJHipsterApp.task.title')" for="task-title">Title</label>
            <input
              type="text"
              class="form-control"
              name="title"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('primeiraAplicacaoJHipsterApp.task.description')" for="task-description"
              >Description</label
            >
            <input
              type="text"
